...
EXTEND_TOP ~dbandoth~ 26
  IF ~Global("A7!GolemAbility", "GLOBAL", 1) Global("A7!DornsDeepWorkshop", "GLOBAL", 0)~ 
    DO ~SetGlobal("A7!DornsDeepWorkshop", "GLOBAL", 1) ContainerEnable("A7!Furnace1", TRUE) SetRestEncounterProbabilityDay(0) SetRestEncounterProbabilityNight(0) AddAreaType(CANRESTOTHER) AddJournalEntry(@140004, QUEST)~ + bandoth.1
END
...
APPEND ~dbandoth~
  ...
  IF ~~ bandoth.3.3
    ...
    IF ~~ DO ~SetGlobal("A7!DornsDeepWorkshop", "GLOBAL", 1) ContainerEnable("A7!Furnace1", TRUE) SetRestEncounterProbabilityDay(0) SetRestEncounterProbabilityNight(0) AddAreaType(CANRESTOTHER) AddJournalEntry(@140002, QUEST)~ EXIT
  END
  ...
  IF ~~ bandoth.4
    ...
    IF ~~ DO ~SetGlobal("A7!DornsDeepWorkshop", "GLOBAL", 1) ContainerEnable("A7!Furnace1", TRUE) SetRestEncounterProbabilityDay(0) SetRestEncounterProbabilityNight(0) AddAreaType(CANRESTOTHER) AddJournalEntry(@140003, QUEST)~ EXIT
  END
