...
APPEND ~scjerlia~
  ...
  IF WEIGHT #4 ~Global("A7!GolemAbility", "GLOBAL", 1) !Global("A7!Intro", "MYAREA", 0)~ jerlia.intro.2
    ...
    + ~!Global("A7!UpdateStore", "MYAREA", 1)~ + @44502 /* Yes, I'd like to browse your store again. */ + jerlia.store.2
    + ~Global("A7!UpdateStore", "MYAREA", 1)~ + @44502 /* Yes, I'd like to browse your store again. */ DO ~SetGlobal("A7!UpdateStore", "MYAREA", 2)~ + jerlia.store.3
